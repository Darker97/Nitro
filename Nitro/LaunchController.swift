...
class LaunchController: UIViewController {
    ...
    @IBOutlet var VersionSchrift: UILabel!

    var WurdeGeladen = false

    @IBOutlet var weba: WKWebView!
    ...
    override func viewDidLoad() {
        ...
        ladenDerSachen()
        if WurdeGeladen {
            performSegue(withIdentifier: "MenübildschirmWechsel", sender: nil)
        }
    }
    ...
    override func viewDidAppear(_: Bool) {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + .seconds(3), execute: {
            ...
            if main.Online {
                self.performSegue(withIdentifier: "MenübildschirmWechsel", sender: nil) } else {
