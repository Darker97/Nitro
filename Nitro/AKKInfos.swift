...
class AKKInfos: UITableViewController {
    fileprivate let feedParser = FeedParser()
    fileprivate let feedURL = main.AktuelleMeldungenLink
...
/*
 ...
 return main.RSSAKKTitle.count
 }

 override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
 let cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath)

 let item = main.RSSAKKTitle[indexPath.row]
 ...
 self.performSegue(withIdentifier: "showAKK", sender: nil)
 }
